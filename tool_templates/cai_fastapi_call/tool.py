...
class ToolParameters(BaseModel):
    ...
    """
    call_type: Literal["docs", "method"] = Field(description="Whether to return the OpenAPI definition, or run an HTTP method to use for the API call.", default="docs") 
