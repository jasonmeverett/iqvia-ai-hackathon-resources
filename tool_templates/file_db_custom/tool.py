...
class ToolParameters(BaseModel):
    ...
    """
    describe: Optional[Literal['true', 'false']] = Field(description="Used to ONLY describe the database table. This is a boolean value to describe the database table.", default='false')
