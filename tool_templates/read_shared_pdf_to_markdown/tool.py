"""
Reads a text-based PDF from the workflow directory and returns the content as a Markdown-formatted string.
"""
...
class ToolParameters(BaseModel):
    input_file: str = Field(description="The workflow directory-relative local path to the PDF file to read. example: 'report.pdf'")
